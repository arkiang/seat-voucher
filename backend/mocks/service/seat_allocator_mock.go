...
// Source: internal/service/seat_allocator_mock.go
//
// Generated by this command:
//
//	mockgen -source=internal/service/seat_allocator_mock.go -destination=mocks/service/seat_allocator_mock.go -package=mocks
//
...
func (m *MockSeatAllocator) GenerateSeats(aircraft model.AircraftType, count int) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateSeats", aircraft, count)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSeatAllocatorMockRecorder) GenerateSeats(aircraft, count any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateSeats", reflect.TypeOf((*MockSeatAllocator)(nil).GenerateSeats), aircraft, count)
}
